...
$resultSetMappingBuilder->addJoinedEntityFromClassMetadata('Blog\Entity\Post', 'p', 'c', 'post',
	[ 
		'id' => 'post_id', 
		'body' => 'post_body', 
...
$sql = "SELECT id, publicationDate, body, post_id
		FROM Comment
...
foreach ($comments as $comment) 
{
	...
	echo sprintf('Date of publication: %s%s', $comment->getPublicationDate()
		->format('r'), PHP_EOL);
